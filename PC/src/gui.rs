...
//                     set_button_style(ui, T0, ACCENT_HOVER, C1);
...
//                     // Button 2: Remove
//                     set_button_style(ui, DANGER_RED, DANGER_HOVER, T1);
//                     if ui
//                         .add_enabled(
//                             can_remove,
...
//                 ui.horizontal(|ui| {
//                     // Button 3: Start
//                     set_button_style(ui, C4, egui::Color32::from_rgb(129, 140, 248), T1);
//                     if ui
//                         .add_enabled(
//                             can_start,
...
impl App {
    ...
    // Nieuwe specifieke constructor voor eframe:
